<template>
  <aside class="menu nav">
    ...
    <p class="menu-label" v-if="!tags.length">Global</p>
    ...
    <p class="menu-label" v-if="!tags.length">Atoms</p>
    <ul class="menu-list" v-if="!tags.length">
      <atomic-nav-item
        :item="child"
        parentName="atoms"
    ...
    <p class="menu-label" v-if="!tags.length">Molecules</p>
    <ul class="menu-list" v-if="!tags.length">
      <atomic-nav-item
        :item="child"
    ...
    <p class="menu-label" v-if="!tags.length">Organisms</p>
    <ul class="menu-list" v-if="!tags.length">
      <atomic-nav-item
        :item="child"
    ...
    <ul class="menu-list" v-if="!tags.length && pagesVisible">
      <li>
        <router-link :to="{ path: '/pageBuilder' }">Build</router-link>
      </li>
    </ul>
    <p class="menu-label" v-if="tags.length">Tags</p>
    <ul class="menu-list" v-if="tags.length">
      <atomic-tag-item
        :item="item"
        :tags="tags"
